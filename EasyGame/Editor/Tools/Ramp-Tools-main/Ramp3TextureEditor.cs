...
public class Ramp3TextureEditor
{
    ...
    private void OnGUI(Material material)
    {
        ...
        _rampTextureData =
            EditorGUILayout.ObjectField("Ramp数据文件", _rampTextureData, typeof(RampTextureData), false) as
                RampTextureData;
        ...
        _gradients[0] = EditorGUILayout.GradientField("圈1", _gradients[0]);
        _gradients[1] = EditorGUILayout.GradientField("圈2", _gradients[1]);
        _gradients[2] = EditorGUILayout.GradientField("圈3", _gradients[2]);
        _gradients[3] = EditorGUILayout.GradientField("圈4", _gradients[3]);
        _gradients[4] = EditorGUILayout.GradientField("圈5", _gradients[4]);
    ...
    private void DrawSave(Material material)
    {
        EditorGUILayout.BeginHorizontal();
    ...
    public void InitScriptable(Material material, float val)
    {
        ...
        // string path = $"Assets/Editor/{material.name}.asset";
        ...
        for (int i = _gradients.Count; i < 5; i++)
        {
