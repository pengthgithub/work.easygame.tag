...
namespace UnityEditor.AddressableAssets.Settings
{
    ...
    public class ProjectConfigData
    {
        ...
        class ConfigSaveData
        {
            ...
            [SerializeField]
            internal bool autoConfig = false;
            [SerializeField]
            internal List<string> autoConfigSetting = new List<string>();
        ...
        public static bool AutoAddConfig
        {
            get 
            {         
                ValidateData();
                return s_Data.autoConfig; 
            }
            set
            {
                ValidateData();
                if (s_Data.autoConfig != value)
                {
                    s_Data.autoConfig = value;
                    SaveData();
                }
            }
        }
        public static List<string> AutoConfigSetting
        {
            get
            {
                ValidateData();
                return s_Data.autoConfigSetting;
            }
        }
        ...
        public static void AddAutoConfigSetting(string reportFilePath)
        {
            ValidateData();
            s_Data.autoConfigSetting.Add(reportFilePath);
            SaveData();
        }
        ...
        public static void RemoveAutoConfigSetting(int index)
        {
            ValidateData();
            s_Data.autoConfigSetting.RemoveAt(index);
            SaveData();
        }
        ...
        public static void ModifyAutoConfigSetting(int index ,string reportFilePath)
        {
            ValidateData();
            s_Data.autoConfigSetting[index] = reportFilePath;
            SaveData();
        }
        ...
        /// </summary>
        public static void ClearAutoConfigSetting()
        {
            ValidateData();
            s_Data.autoConfigSetting.Clear();
            SaveData();
        }
        ...
        static void ValidateData()
        {
            if (s_Data == null)
            {
                ...
                dataPath += "/ProjectSettings/AddressablesConfig.asset";
                ...
                if (s_Data.autoConfigSetting == null)
                    s_Data.autoConfigSetting = new List<string>();
            }
        }
